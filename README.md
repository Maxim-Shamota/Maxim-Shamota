...
Пока приостанавливаю работу над этим сайтом - навалилась работа и надо бек-энд делать(или будет очень сильное дублирование кода). Так что пойду вспоминать Python и Django.


(- Планирую натянуть верстку на WP или напишу свою админку на React (пока не решил)
- Далее планирую пересобрать его на React.
- И напоследок - реализовать его в Native.(это уж если свободное время позволит))
